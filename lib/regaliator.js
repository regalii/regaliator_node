...
function Regaliator(apiHost, apiKey, secret, version) {
  if (!(this instanceof Regaliator)) {
    return new Regaliator(apiHost, apiKey, secret, version);
  }

  this.request = new Request(apiHost, apiKey, secret, version);
